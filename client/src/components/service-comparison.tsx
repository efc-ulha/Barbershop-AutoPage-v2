    ...
    <section id="services" className="py-20 bg-gradient-to-b from-white to-fa-slate-50">
      <div className="container mx-auto px-4">
        ...
        <div className="grid md:grid-cols-2 gap-8 max-w-6xl mx-auto">
          ...
          <div className="barber-card rounded-2xl p-8 border-2 border-slate-200 hover:border-fa-primary transition-all duration-300 hover:shadow-2xl relative group">
            ...
            <div className="text-center mb-8">
              ...
              <div className="flex items-baseline justify-center gap-2 mb-2">
                <span className="text-5xl font-bold text-fa-primary">$120</span>
                <span className="text-sm text-slate-500">+ $8/mo</span>
              </div>
              <p className="text-sm text-fa-gold font-semibold">⚡ Preview ready in 5 minutes</p>
            </div>
          ...
          <div className="bg-white rounded-2xl p-8 border-2 border-fa-gold hover:shadow-2xl transition-all duration-300 group relative">
            <div className="absolute top-4 right-4 bg-fa-gold text-white px-4 py-2 rounded-full text-xs font-bold">
              🏆 PREMIUM
            </div>
            <div className="absolute -top-10 -right-10 w-32 h-32 bg-fa-gold opacity-5 rounded-full group-hover:scale-150 transition-transform duration-500"></div>
            
            <div className="text-center mb-8 relative z-10">
              <div className="w-20 h-20 bg-gradient-to-br from-fa-gold to-fa-accent rounded-2xl flex items-center justify-center mx-auto mb-6 shadow-lg group-hover:scale-110 transition-transform">
                <i className="fas fa-crown text-white text-3xl"></i>
              </div>
              <h3 className="text-2xl font-bold mb-3 barber-heading text-fa-secondary">Custom Design</h3>
              <p className="text-fa-slate-600 mb-6">Bespoke barbershop websites that set you apart</p>
              <div className="flex items-baseline justify-center gap-2 mb-2">
                <span className="text-5xl font-bold text-fa-gold">$89</span>
                <span className="text-sm text-fa-slate-500">/consultation</span>
              </div>
            ...
            <button 
              ...
              className="barber-button w-full bg-fa-gold hover:bg-fa-accent text-white py-4 rounded-xl font-bold text-lg transition-all transform hover:scale-[1.02] shadow-xl relative z-10"
            >
